...
contract CryptoBoxWHEEL is ReentrancyGuard, AccessControl {
    ...
    function openLootBoxV1(
        ...
        if (countOfOpenV1[receiver] == 30) {
            ...
            if (randomNumber[0] < 70) {
                //Every 30 open
                ICryptoBoxFactory(factory).mint(16, receiver); //common type3
            } else if (randomNumber[0] > 70 && randomNumber[0] < 95) {
                ICryptoBoxFactory(factory).mint(17, receiver); //uncommon type 2
            } else if (randomNumber[0] > 95) {
                ICryptoBoxFactory(factory).mint(18, receiver); //rare type 1
            }
        } else if (randomNumber[0] < 5) {
            //second case
            //Items 5% chance
            if (randomNumber[1] < 60) {
                ICryptoBoxFactory(factory).mint(16, receiver);
                itemsDroped = true;
            } else if (randomNumber[1] > 60 && randomNumber[1] < 90) {
                ICryptoBoxFactory(factory).mint(17, receiver);
                itemsDroped = true;
            } else {
                ICryptoBoxFactory(factory).mint(18, receiver);
                itemsDroped = true;
            }
        } else if (
            (itemsDroped =
    ...
    function openLootBoxV2(
        ...
        if (countOfOpenV2[receiver] == 20) {
            ...
            if (randomNumber[0] < 70) {
                //Every 30 open
                ICryptoBoxFactory(factory).mint(18, receiver); //type rare
            } else if (randomNumber[0] > 70 && randomNumber[0] < 95) {
                ICryptoBoxFactory(factory).mint(17, receiver); //type  uncommon
            } else if (randomNumber[0] > 95) {
                ICryptoBoxFactory(factory).mint(19, receiver); //type  epic
            }
        } else if (randomNumber[0] < 5) {
            //second case
            //Items 5% chance
            if (randomNumber[1] < 60) {
                ...
                ICryptoBoxFactory(factory).mint(19, receiver);
                itemsDroped = true;
            }
        } else if (
            (itemsDroped =
    ...
    function openLootBoxV3(
        ...
        if (countOfOpenV3[receiver] == 20) {
            ...
            if (randomNumber[0] < 70) {
                ...
                ICryptoBoxFactory(factory).mint(20, receiver);
            }
        } else if (randomNumber[0] < 5) {
            //second case
            //Items 5% chance
