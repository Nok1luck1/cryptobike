    ...
    function openLootBoxV1(
        ...
        if (countOfOpenV1[receiver] == 30) {
            ...
            if (randomNumber[0] < 48) {
                //Every 30 open
                ICryptoBoxFactory(factory).mint(49, receiver);
            } else if (randomNumber[0] > 48 && randomNumber[0] < 95) {
                ICryptoBoxFactory(factory).mint(55, receiver);
            } else if (randomNumber[0] > 95) {
                ICryptoBoxFactory(factory).mint(61, receiver);
            }
            ...
            if (randomNumber[1] < 60) {
                ...
                if (randomNumber[2] > 34 && randomNumber[2] < 68) {
                    ICryptoBoxFactory(factory).mint(54, receiver);
                    itemsDroped = true;
                }
                if (randomNumber[2] > 68) {
                    ICryptoBoxFactory(factory).mint(59, receiver);
                    itemsDroped = true;
                }
            } else if (randomNumber[1] > 60 && randomNumber[1] < 90) {
                if (randomNumber[2] < 51) {
                    ICryptoBoxFactory(factory).mint(50, receiver);
                    itemsDroped = true;
                ...
                if (randomNumber[2] < 51) {
                    ICryptoBoxFactory(factory).mint(51, receiver);
                    itemsDroped = true;
                } else if (randomNumber[2] > 51) {
                    ICryptoBoxFactory(factory).mint(56, receiver);
                    itemsDroped = true;
                }
            }
        } else if (
            ...
            if (randomNumber[5] < 51) {
                if (randomNumber[6] < 60) {
                    emit MaterialDroped(
                        PartsLibrary.Materials.TRANSMISSION,
                        15,
    ...
    function openLootBoxV2(
        ...
        if (countOfOpenV2[receiver] == 20) {
            ...
            if (randomNumber[0] < 13) {
                ICryptoBoxFactory(factory).mint(50, receiver);
            } else if (randomNumber[0] > 13 && randomNumber[0] < 27) {
                ICryptoBoxFactory(factory).mint(55, receiver);
            } else if (randomNumber[0] > 27 && randomNumber[0] < 96) {
                ICryptoBoxFactory(factory).mint(61, receiver);
            } else if (randomNumber[0] > 96 && randomNumber[0] < 98) {
                ICryptoBoxFactory(factory).mint(52, receiver);
            } else {
                ICryptoBoxFactory(factory).mint(57, receiver);
            }
        } else if (randomNumber[0] < 5) {
            //second case
            //Items 5% chance
            if (randomNumber[1] < 60) {
                ...
                if (randomNumber[2] > 68) {
                    ICryptoBoxFactory(factory).mint(60, receiver);
                    itemsDroped = true;
                }
            } else if (randomNumber[1] > 60 && randomNumber[1] < 90) {
                //rare
    ...
    function openLootBoxV3(
        ...
        if (countOfOpenV3[receiver] == 20) {
            ...
            if (randomNumber[0] < 13) {
                ...
                ICryptoBoxFactory(factory).mint(62, receiver);
            } else if (randomNumber[0] > 96 && randomNumber[0] < 98) {
                ICryptoBoxFactory(factory).mint(53, receiver);
            } else if (randomNumber[0] > 98) {
                ICryptoBoxFactory(factory).mint(58, receiver);
            }
        } else if (randomNumber[0] < 5) {
            //second case
            //Items 5% chance
            if (randomNumber[1] < 60) {
                ...
                if (randomNumber[2] < 40) {
                    ICryptoBoxFactory(factory).mint(53, receiver);
                    itemsDroped = true;
                } else if (randomNumber[2] > 40 && randomNumber[2] < 80) {
                    ICryptoBoxFactory(factory).mint(58, receiver);
                    itemsDroped = true;
                } else if (randomNumber[2] > 80) {
                    ICryptoBoxFactory(factory).mint(63, receiver);
                    itemsDroped = true;
                }
            }
        } else if (
