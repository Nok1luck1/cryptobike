...
contract CryptoBoxFUEL_TANK is ReentrancyGuard, AccessControl {
    ...
    function openLootBoxV1(
        ...
        if (countOfOpenV1[receiver] == 30) {
            ...
            if (randomNumber[0] < 70) {
                //Every 30 open
                ICryptoBoxFactory(factory).mint(11, receiver); //common type3
            } else if (randomNumber[0] > 70 && randomNumber[0] < 95) {
                ICryptoBoxFactory(factory).mint(12, receiver); //uncommon type 2
            } else if (randomNumber[0] > 95) {
                ICryptoBoxFactory(factory).mint(13, receiver); //rare type 1
            }
        } else if (randomNumber[0] < 5) {
            //second case
            //Items 5% chance
            if (randomNumber[1] < 60) {
                ICryptoBoxFactory(factory).mint(11, receiver);
                itemsDroped = true;
            } else if (randomNumber[1] > 60 && randomNumber[1] < 90) {
                ICryptoBoxFactory(factory).mint(12, receiver);
                itemsDroped = true;
            } else {
                ICryptoBoxFactory(factory).mint(13, receiver);
                itemsDroped = true;
            }
        } else if (
            (itemsDroped =
            ...
            if (randomNumber[5] < 51) {
                if (randomNumber[6] < 60) {
                    emit MaterialDroped(
                        PartsLibrary.Materials.FUEL_TANK,
                        15,
    ...
    function openLootBoxV2(
        ...
        if (countOfOpenV2[receiver] == 20) {
            ...
            if (randomNumber[0] < 70) {
                //Every 30 open
                ICryptoBoxFactory(factory).mint(12, receiver); //type 3 uncommon
            } else if (randomNumber[0] > 70 && randomNumber[0] < 95) {
                ICryptoBoxFactory(factory).mint(13, receiver); //type 2 rare
            } else if (randomNumber[0] > 95) {
                ICryptoBoxFactory(factory).mint(14, receiver); //type 1 epic
            }
        } else if (randomNumber[0] < 5) {
            //second case
            //Items 5% chance
            if (randomNumber[1] < 60) {
                ...
                ICryptoBoxFactory(factory).mint(14, receiver);
                itemsDroped = true;
            }
        } else if (
            (itemsDroped =
    ...
    function openLootBoxV3(
        ...
        if (countOfOpenV3[receiver] == 20) {
            ...
            if (randomNumber[0] < 70) {
                ...
                ICryptoBoxFactory(factory).mint(15, receiver);
            }
        } else if (randomNumber[0] < 5) {
            //second case
            //Items 5% chance
